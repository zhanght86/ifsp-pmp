...
<snow:page title="动态树预览">
	<snow:layout id="">
		<snow:Layoutleft id="" width="400">
			...
			<snow:button id="b41" desc="刷新11"></snow:button>
			...
			<snow:button id="b53" desc="展开11,12">
			</snow:button>
		...
		<snow:Layoutcenter id="">
			<snow:dataset id="Tree" path="com.ruimin.ifs.example.dataset.Tree" init="true" parameters="async=true"></snow:dataset>
			<snow:tree dataset="Tree" id="tree" async="true" checkboxs="true"></snow:tree>
		</snow:Layoutcenter>
	</snow:layout>
	...
	<script>
		...
		function b41_onClick() {
			tree_tree.refresh("11");
			//Tree_dataset.flushData();
		}
