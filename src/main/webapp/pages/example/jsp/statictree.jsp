...
<snow:page title="动态树预览">
	...
	<snow:dataset id="StaticTreeNode" path="" init="true"></snow:dataset>
	<div id="tree" extra="tree" datasetid="StaticTreeNode_dataset" data-options="async:false,checkboxs:true"></div>
