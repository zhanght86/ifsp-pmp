...
<snow:page title="活动管理参与商户审核页面">
	...
	<snow:grid id="gridMchtIn"   dataset="mchtIn" fieldstr="mchtId,mchtName,mchtAreaNo,inFlg,mchtLevl" 
			height="70%" border="true" label="参与商户" editable="false" fitcolumns="true" pagination="true" 
			collapsible="true">
	</snow:grid>
	...
	function initCallGetter_post() {
		...
		mchtIn_dataset.setParameter("qActiveNo",activeNo);
		mchtIn_dataset.setParameter("qinFlg","1");
