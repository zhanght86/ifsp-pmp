 ...
 */
@Service
public class PassWordMngService extends SnowService {

	public static PassWordMngService getInstance() throws SnowException {
		return ContextUtil.getSingleService(PassWordMngService.class);
	}
