...
public class RiskModelCfgVO {
	...
	public String getRiskModelTypeSel() {
		return riskModelTypeSel;
	}
	public void setRiskModelTypeSel(String riskModelTypeSel) {
		this.riskModelTypeSel = riskModelTypeSel;
	}
	public String getActionBitmapSel() {
		return actionBitmapSel;
	}
	public void setActionBitmapSel(String actionBitmapSel) {
		this.actionBitmapSel = actionBitmapSel;
	}
	...
	public String getChangeValueModel() {
		return changeValueModel;
	}
	public void setChangeValueModel(String changeValueModel) {
		this.changeValueModel = changeValueModel;
	}
