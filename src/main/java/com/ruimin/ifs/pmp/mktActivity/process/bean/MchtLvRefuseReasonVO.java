...
@Table("TBL_MCHT_LV_REFUSE_REASON")
public class MchtLvRefuseReasonVO {
	/**
	 * 表名: TblMchtLvRefuseReason alias 用于页面显示对应中英文信息  .
	 */
	public static final String TABLE_ALIAS = "TblMchtLvRefuseReason";
	/** 列 MCHT_ID 的对应中英文信息. */
