...
@Table("TBL_METHOD_REFUSE_REASON")
public class MethodRefuseReasonVO {
	/**
	 * 表名: TblMethodRefuseReason alias 用于页面显示对应中英文信息  .
	 */
	public static final String TABLE_ALIAS = "TblMethodRefuseReason";
