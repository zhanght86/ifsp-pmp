...
@Table("TBL_ACTIVE_CYCLE_CONF")
public class ActiveCycleConfVO2 {
	/**
	...
	public static final String ALIAS_DATE_DATE = "当周期类型为（01：具体日期）时MMDD当周期类型为（02：每月X日）时NN（01~31）当周期类型为（03：星期X）时N（1~7）当周期类型为（04：工作日节假日区分）时N（1-工作日；0-节假日）";
