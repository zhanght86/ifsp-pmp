...
@Table("TBL_ACTIVE_SHOW_INF_TMP")
public class ActiveShowInfTmpVO {
	/**
	 * 表名: TblActiveShowInfTmp alias 用于页面显示对应中英文信息 .
	 */
	public static final String TABLE_ALIAS = "TblActiveShowInfTmp";
