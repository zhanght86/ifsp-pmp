...
@Table("TBL_ACTIVE_MCHT_IN_INF")
public class ActiveMchtInInfVO {
	/**
	 * 表名: TblActiveMchtInInf alias 用于页面显示对应中英文信息  .
	 */
	public static final String TABLE_ALIAS = "TblActiveMchtInInf";
