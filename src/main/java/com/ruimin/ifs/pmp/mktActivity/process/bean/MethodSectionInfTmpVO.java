...
@Table("TBL_METHOD_SECTION_INF_TMP")
public class MethodSectionInfTmpVO {
	/**
	 * 表名: TblMethodSectionInfTmp alias 用于页面显示对应中英文信息  .
	 */
	public static final String TABLE_ALIAS = "TblMethodSectionInfTmp";
