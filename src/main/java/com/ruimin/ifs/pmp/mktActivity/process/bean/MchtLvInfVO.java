...
@Table("TBL_MCHT_LV_INF")
public class MchtLvInfVO {
	/**
	 * 表名: TblMchtLvInf alias 用于页面显示对应中英文信息  .
	 */
	public static final String TABLE_ALIAS = "TblMchtLvInf";
	/** 列 MCHT_ID 的对应中英文信息. */
	public static final String ALIAS_MCHT_ID = "mchtId";
	/** 列 MCHT_NM 的对应中英文信息. */
	public static final String ALIAS_MCHT_NM = "mchtNm";
	...
	public static final String ALIAS_LV_STAT = "lvStat";
