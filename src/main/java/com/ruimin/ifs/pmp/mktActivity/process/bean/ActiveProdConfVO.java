...
@Table("TBL_ACTIVE_PRD_CONF")
public class ActiveProdConfVO {
	/**
	 * 表名: 活动对应的支付产品清单，1个活动可以对应多个支付产品 alias 用于页面显示对应中英文信息  .
	 */
	public static final String TABLE_ALIAS = "活动对应的支付产品清单，1个活动可以对应多个支付产品";
