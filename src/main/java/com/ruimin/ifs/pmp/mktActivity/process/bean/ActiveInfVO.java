...
@Table("TBL_ACTIVE_INF")
public class ActiveInfVO {
	/**
	 * 表名: TblActiveInf alias 用于页面显示对应中英文信息  .
	 */
	public static final String TABLE_ALIAS = "TblActiveInf";
	...
	public static final String ALIAS_ACTIVE_STAT = "第一位：0-审核流程;1-运行流程;9-结束流程01：审核中02：审核通过03：审核拒绝10：准备完成11：活动中12：暂停中99：已关闭该状态从审核过后由批量维护";
	...
	/** 列 PTK_TIMES 的对应中英文信息. */
	public static final String ALIAS_PTK_TIMES = "第一位为类型0：无限制1：全活动周期2：月3：日";
	 ...
	 * @param  java.lang.String
	 */	
	public void setPtkTimes(String value) {
		this.ptkTimes = value;
	}
	/**
	 * PtkTimes 取值.
    ...
    /**
     * @return the mchtCount
     */
    public String getMchtCount() {
        return mchtCount;
    }
    /**
     * @param mchtCount the mchtCount to set
     */
