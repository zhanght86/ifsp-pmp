...
@Table("PBS_MCHT_CONTR_PIC_INFO_TMP")
public class MchtContractPicVO {
	@Id
	...
	public MchtContractPicVO(String conId, String picSerNum, String picId, String picPath, String crtTlr,
