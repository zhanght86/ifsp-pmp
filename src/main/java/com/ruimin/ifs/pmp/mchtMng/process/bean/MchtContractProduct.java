 ...
 * 说明：<br>
 */
@Table("PBS_MCHT_REL_CONTR_PROD_TMP")
public class MchtContractProduct {
	...
	public MchtContractProduct() {

	}

	public MchtContractProduct(String conId, String prodId, String dataState, String crtTlr, String crtDateTime,
