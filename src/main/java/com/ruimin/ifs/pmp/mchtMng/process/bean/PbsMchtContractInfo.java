...
@Table("PBS_MCHT_CONTRACT_INFO")
public class PbsMchtContractInfo {
    ...
    /**
     * @param accountBoss the accountBoss to set
     */
    ...
    /**
     * @param setlBankPhone the setlBankPhone to set
     */
	...
	public PbsMchtContractInfo(String conId, String mchtId, String paperConId, String startDate, String endDate,
			String extendFlag, String conTerm, String conState, String setlType, String setlSymbol, String setlCycle,
			String specSetlDay, String setlAcctType, String setlAcctName, String setlAcctNo, String setlCertType,
			String setlCertNo, String auditId, String syncState, String setlAcctInstitute, String crtTlr,
